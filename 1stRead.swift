...
First thing needed to be said is that U is not Internet.
...
U Home Station has built-in interfaces that allow to connect it to other nodes via wireless, wired or wide area network. Once you connect to another node, the setup is done.
